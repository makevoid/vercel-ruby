  ...
  "../../node_modules/.pnpm/execa@2.0.4/node_modules/execa/index.js"(exports, module2) {
    ...
    var execa3 = (file, args, options) => {
      ...
      const handlePromise = async () => {
        const [{ error, code, signal, timedOut }, stdoutResult, stderrResult, allResult] =
    ...
    module2.exports.node = (scriptPath, args, options = {}) => {
      ...
      return execa3(nodePath, [...nodeOptions, scriptPath, ...(Array.isArray(args) ? args : [])], {
        ...options,
        stdin: void 0,
        stdout: void 0,
        stderr: void 0,
...
var require_graceful_fs = __commonJS({
  "../../node_modules/.pnpm/graceful-fs@4.2.11/node_modules/graceful-fs/graceful-fs.js"(exports, module2) {
    ...
    var debug3 = noop;
    if (util.debuglog) debug3 = util.debuglog("gfs4");
  ...
  "../../node_modules/.pnpm/semver@6.3.1/node_modules/semver/semver.js"(exports, module2) {
    ...
    function coerce(version2, options) {
      ...
      if (!options.rtl) {
        ...
        var next;
        while (
          (next = safeRe[t.COERCERTL].exec(version2)) &&
...
function getRubyPath(meta, gemfileContents) {
  ...
  let gemHome = "/ruby" + major + minor;
  if (process.env.USER === "makevoid") {
    gemHome = "/Users/makevoid/.rvm/rubies/ruby-3.3.0";
  }
  const result = {
    major,
    gemHome,
...
function isInstalled({ major, minor }) {
  ...
  return (
    Boolean(import_which.default.sync((0, import_path.join)(gemHome, "bin/ruby"), { nothrow: true })) &&
    Boolean(import_which.default.sync((0, import_path.join)(gemHome, "bin/gem"), { nothrow: true }))
  );
}
...
var version = 3;
var build = async ({ workPath, files, entrypoint, config, meta = {} }) => {
  ...
  const { gemHome, bundlerPath, vendorPath, runtime, rubyPath, major } = await installBundler(
    meta,
    gemfileContents,
  );
  ...
  if (!hasVendorDir) {
    if (gemfilePath) {
      (0, import_build_utils2.debug)("did not find a vendor directory but found a Gemfile, bundling gems...");
